...
func (c *ConfigCenterV2) GetCertPemPath() (string, error) {
	return c.getPath(DEFAULT_CERT_PEM_FILE_NAME)
}

// 获取证书 .key 路径
func (c *ConfigCenterV2) GetCertKeyPath() (string, error) {
	return c.getPath(DEFAULT_CERT_KEY_FILE_NAME)
}
...
func (c *ConfigCenterV2) getPath(key string) (string, error) {
	...
	return strings.Join([]string{DEFAULT_GLOBAL_PATH, "certs", serverTag, key}, "/"), nil
}
