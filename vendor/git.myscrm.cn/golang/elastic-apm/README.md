...
[![GoDoc](https://godoc.org/git.myscrm.cn/golang/elastic-apm?status.svg)](http://godoc.org/git.myscrm.cn/golang/elastic-apm)
...
[![Go Report Card](https://goreportcard.com/badge/git.myscrm.cn/golang/elastic-apm)](https://goreportcard.com/report/git.myscrm.cn/golang/elastic-apm)
...
```bash
go get -u git.myscrm.cn/golang/elastic-apm
```
